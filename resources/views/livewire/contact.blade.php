                            ...
                            <div class="weekly-office-hours">
                                <ul>
                                    <li class="d-flex align-items-center justify-content-between">
                                        <span>Luni - Vineri</span> <span>{{ $this->agency?->weekly_hours }}</span></li>
                                    <li class="d-flex align-items-center justify-content-between"><span>Sambata</span>
                                        <span>{{ $this->agency?->saturday_hours }}</span></li>
                                    <li class="d-flex align-items-center justify-content-between"><span>Duminica</span> <span>{{ $this->agency?->sunday_hours }}</span>
                                    </li>
                                </ul>
                            </div>
                            <!-- Address -->
